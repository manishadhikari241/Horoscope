...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
            ...
            <div class="sidebar-brand-text mx-3">Horoscope</div>
        </a>
        ...
        <li class="nav-item">
            ...
            <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                ...
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('add-privilege')}}">Add Privilege</a>
                    <a class="collapse-item" href="{{route('add-user')}}">Add User</a>
                    <a class="collapse-item" href="utilities-border.html">Show User</a>
                </div>
            </div>
        </li>
        <!-- Divider -->
        ...
        <li class="nav-item">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="{{route('add-horo')}}">Horoscope</a>
                    <a class="collapse-item" href="{{route('show-horo')}}">Show Horoscope</a>
                </div>
            </div>
        </li>
